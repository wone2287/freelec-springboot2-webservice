...
public class PostsRepositoryTest {
    ...
    // 보통은 배포 전 단체 테스트를 수행할 때 테스트간 데이터 침범을 막기 위해 사용합니다.
    // 여러 테스트가 동시에 수행되면 테스트용 데이터베이스인 H2에 데이터가 그대로 남아있어
    // 다음 테스트 실행 시 테스트가 실패 할 수 있음.
    public void cleanup() {
    ...
    public void BaseTimeEntity_등록() {
        ...
        System.out.println(">>>>>>>> createDate=" + posts.getCreatedDate() + ", modifiedData=" + posts.getModifiedDate());
